  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={{ ...FONTS.h1,  fontFamily: 'Montserrat',fontWeight:'700', marginTop: -8, }}>Edit Profile</Text>
      </View>
      ...
      <ScrollView>
        ...
        <View>
          ...
          >
            <Text style={{ ...FONTS.h4 ,fontWeight:'500',fontFamily:'Montserrat'}}>Name</Text>
            <View
              style={{
                height: 44,
                width: "100%",
          ...
          >
            <Text style={{ ...FONTS.h4 ,fontWeight:'500',fontFamily:'Montserrat'}}>Email</Text>
            <View
              style={{
                height: 44,
                width: "100%",
          ...
          >
            <Text style={{ ...FONTS.h4,fontWeight:'500',fontFamily:'Montserrat' }}>Password</Text>
            <View
              style={{
                height: 44,
                width: "100%",
